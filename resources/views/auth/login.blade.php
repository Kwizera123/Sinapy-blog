...
<head>
  ...
  <body class="bg-light-gray" id="body">
            ...
            <div class="card-header bg-primary">
              <div class="app-brand">
                <a href="/index.html">
                  ...
                  <span class="brand-name">Sinapy Dashboard</span>
                </a>
              </div>
            </div>
      ...
      <div class="copyright pl-0">
        <p class="text-center">&copy; 2018 Copyright Sinapy Dashboard by
          <a class="text-primary" href="#" target="_blank">Sinapy</a>.
        </p>
      </div>
    </div>
</body>
