...
<html lang="en" dir="ltr">
  ...
  <title>Sinapy - Admin Dashboard </title>
              ...
              <div class="navbar-right ">
                <ul class="nav navbar-nav">
                  ...
                  <li class="dropdown user-menu">
                    <button href="{{ asset('#')}}" class="dropdown-toggle nav-link" data-toggle="dropdown">
...
@yield('admin')
            ...
            <div class="copyright bg-white">
              <p>
                &copy; <span id="copy-year">2019</span> Copyright Sinapy Dashboard by
                <a
                  class="text-primary"
                  href="#"
                  target="_blank"
